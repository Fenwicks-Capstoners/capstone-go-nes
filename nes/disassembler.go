...
var opcodeNameTable = [256]opCodeAndAddrMode{
	{"BRK", implied}, {"ORA", indexIndirect}, {"XXX", implied}, {"XXX", indexIndirect}, {"XXX", zeroPage}, {"ORA", zeroPage}, {"ASL", zeroPage}, {"XXX", zeroPage}, {"PHP", implied}, {"ORA", immediate}, {"ASLA", accumulator}, {"XXX", immediate}, {"XXX", absolute}, {"ORA", absolute}, {"ASL", absolute}, {"XXX", absolute},
	...
	{"JSR", absolute}, {"AND", indexIndirect}, {"XXX", implied}, {"XXX", indexIndirect}, {"BIT", zeroPage}, {"AND", zeroPage}, {"ROL", zeroPage}, {"XXX", zeroPage}, {"PLP", implied}, {"AND", immediate}, {"ROLA", accumulator}, {"XXX", immediate}, {"BIT", absolute}, {"AND", absolute}, {"ROL", absolute}, {"XXX", absolute},
	...
	{"RTI", implied}, {"EOR", indexIndirect}, {"XXX", implied}, {"XXX", indexIndirect}, {"XXX", zeroPage}, {"EOR", zeroPage}, {"LSR", zeroPage}, {"XXX", zeroPage}, {"PHA", implied}, {"EOR", immediate}, {"LSRA", accumulator}, {"XXX", immediate}, {"JMP", absolute}, {"EOR", absolute}, {"LSR", absolute}, {"XXX", absolute},
	...
	{"RTS", implied}, {"ADC", indexIndirect}, {"XXX", implied}, {"XXX", indexIndirect}, {"XXX", zeroPage}, {"ADC", zeroPage}, {"ROR", zeroPage}, {"XXX", zeroPage}, {"PLA", implied}, {"ADC", immediate}, {"RORA", accumulator}, {"XXX", immediate}, {"JMP", indirect}, {"ADC", absolute}, {"ROR", absolute}, {"XXX", absolute},
